...
public class AlgoVisHelper {
    ...
    public static void setStrokeWidth(Graphics2D g2d, int w){  //左边将绘图的上下文环境传给函数, w粗细
        int strokeWidth = w; //笔画宽度
        g2d.setStroke(new BasicStroke(strokeWidth, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND)); //CAP绘制的端点都是圆形，JOIN拐歪时的拐点是平滑的圆形
    }
